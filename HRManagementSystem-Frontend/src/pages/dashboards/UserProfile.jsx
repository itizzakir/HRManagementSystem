      ...
      case "Contact Details":
        ...
        return (
          <div className="bg-white p-6 rounded-lg shadow w-full max-w-6xl">
            <h2 className="text-lg font-semibold mb-4">Academic Records / Academic Details</h2>
            <div className="grid grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-sm font-semibold mb-1">Name of Institution</label>
                <div className="bg-blue-100 p-3 rounded">Babcock University</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="bg-blue-100 p-3 rounded">Ogun state, Nigeria</div>
              </div>
              <div>
                <label className="block text-sm font-semibold mb-1">Start Date</label>
                <input type="date" className="bg-blue-100 p-3 rounded w-full" defaultValue="1998-01-01" />
              </div>
              <div>
                <label className="block text-sm font-semibold mb-1">End Date</label>
                <input type="date" className="bg-blue-100 p-3 rounded w-full" defaultValue="2019-01-01" />
              </div>
              <div className="col-span-2">
