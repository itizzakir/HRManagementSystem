    ...
    >
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow">
            ...
            <div className="mt-4 flex space-x-3">
              <button className="bg-gray-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-gray-700">
                View All Users
              </button>
              <button
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <CogIcon className="h-5 w-5 mr-2" /> Manage System Settings
                </a>
              </li>
              {/* Other links... */}
            </ul>
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow">
          ...
          <button className="mt-4 bg-gray-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-gray-700">
            View All Logs
          </button>
        </div>
      </div>
