...
import { CalendarDaysIcon, CurrencyDollarIcon, DocumentTextIcon, UserCircleIcon } from '../../components/ui/Icons';

const InfoCard = ({ title, children, actionText, onAction }) => (
    <div className="bg-white p-6 rounded-lg shadow h-full">
        <div className="flex justify-between items-start mb-4">
            <h3 className="text-xl font-semibold text-gray-800">{title}</h3>
            {actionText && <button onClick={onAction} className="text-sm font-semibold text-green-600 hover:underline">{actionText}</button>}
        </div>
        <div>{children}</div>
    </div>
);
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <InfoCard title="My Team">
                           <ul className="space-y-3">
                               <li className="flex items-center space-x-3"><UserCircleIcon className="h-8 w-8 text-gray-400"/><div><p className="font-semibold text-sm">Jane Doe</p><p className="text-xs text-gray-500">HR Manager</p></div></li>
                               <li className="flex items-center space-x-3"><UserCircleIcon className="h-8 w-8 text-gray-400"/><div><p className="font-semibold text-sm">Bob Williams</p><p className="text-xs text-gray-500">Senior Engineer</p></div></li>
                           </ul>
                        </InfoCard>
                    </div>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <InfoCard title="Quick Actions">
                           <div className="space-y-3">
                             <button className="w-full flex items-center justify-center p-3 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700"><CalendarDaysIcon className="h-5 w-5 mr-2" /> Request Leave</button>
