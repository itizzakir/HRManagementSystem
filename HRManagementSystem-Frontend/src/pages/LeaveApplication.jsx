...
const LeaveApplication = () => {
  ...
  const leaveHistory = [
    { id: 1, name: 'John Steven Doe', duration: 5, startDate: '22/04/2022', endDate: '28/04/2022', type: 'Sick', reason: 'Personal' },
    { id: 2, name: 'John Steven Doe', duration: 7, startDate: '22/04/2022', endDate: '30/04/2022', type: 'Sick', reason: 'Exam' },
    { id: 3, name: 'John Steven Doe', duration: 120, startDate: '22/04/2022', endDate: '28/06/2022', type: 'Maternity', reason: 'Child Care' },
    { id: 4, name: 'John Steven Doe', duration: 5, startDate: '22/04/2022', endDate: '28/04/2022', type: 'Sick', reason: 'Personal' },
    { id: 5, name: 'John Steven Doe', duration: 5, startDate: '22/04/2022', endDate: '28/04/2022', type: 'Sick', reason: 'Personal' },
    { id: 6, name: 'John Steven Doe', duration: 5, startDate: '22/04/2022', endDate: '28/04/2022', type: 'Sick', reason: 'Personal' },
  ];
  ...
  return (
    <DashboardLayout role="user" title="Leave Application" userName="John Smith" userEmail="user@workbridge.com">
      <div className="p-6 max-w-6xl mx-auto bg-white rounded-lg shadow space-y-8">
        ...
        <div>
          ...
          <div className="flex space-x-4 overflow-x-auto pb-2">
            {leaveBalances.map((leave) => (
              <div key={leave.id} className="flex-shrink-0 bg-blue-700 text-white rounded-lg px-6 py-4 flex items-center space-x-6 min-w-[180px]">
                <div className="text-3xl font-bold bg-white text-blue-700 rounded-full w-12 h-12 flex items-center justify-center">{leave.balance}</div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border border-gray-200 rounded-lg">
              <thead className="bg-gray-100">
                <tr>
                  <th className="text-left px-4 py-2 border-b border-gray-300">Name(s)</th>
                  <th className="text-left px-4 py-2 border-b border-gray-300">Duration(s)</th>
                  <th className="text-left px-4 py-2 border-b border-gray-300">Start Date</th>
                  <th className="text-left px-4 py-2 border-b border-gray-300">End Date</th>
                  <th className="text-left px-4 py-2 border-b border-gray-300">Type</th>
                  <th className="text-left px-4 py-2 border-b border-gray-300">Reason(s)</th>
              ...
              <tbody>
                {leaveHistory.map((leave) => (
                  <tr key={leave.id} className="hover:bg-gray-50">
                    <td className="px-4 py-2 border-b border-gray-300">{leave.name}</td>
                    <td className="px-4 py-2 border-b border-gray-300">{leave.duration}</td>
                    <td className="px-4 py-2 border-b border-gray-300">{leave.startDate}</td>
                    <td className="px-4 py-2 border-b border-gray-300">{leave.endDate}</td>
                    <td className="px-4 py-2 border-b border-gray-300">{leave.type}</td>
                    <td className="px-4 py-2 border-b border-gray-300">{leave.reason}</td>
                    <td className="px-4 py-2 border-b border-gray-300">
                      <button className="bg-blue-700 text-white px-3 py-1 rounded hover:bg-blue-800">Actions</button>
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        <div ref={formRef} className="p-6 max-w-lg mx-auto bg-white rounded-lg shadow">
