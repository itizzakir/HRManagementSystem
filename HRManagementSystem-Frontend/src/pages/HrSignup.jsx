...
import { BriefcaseIcon, HomeIcon, WorkBridgeLogoIcon } from '../components/ui/Icons';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl mx-auto lg:grid lg:grid-cols-2 rounded-xl shadow-lg overflow-hidden relative">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=1932')" }}
        >
            <h1 className="text-4xl font-bold mb-3">Find Top-Tier Talent</h1>
            <p className="text-center max-w-sm">
                Join WorkBridge as an HR professional to post jobs, manage candidates, and build your dream team.
            </p>
        </div>
        ...
        <div className="bg-white p-8 md:p-10">
            <div className="text-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-gray-800">Create an HR Account</h1>
            </div>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div><label htmlFor="workEmail" className="block text-sm font-medium text-gray-700">Work E-mail Address</label><input type="email" name="workEmail" id="workEmail" value={formData.workEmail} onChange={handleChange} className="mt-1 w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500" required /></div>
                <div><label htmlFor="companyName" className="block text-sm font-medium text-gray-700">Company Name</label><input type="text" name="companyName" id="companyName" value={formData.companyName} onChange={handleChange} className="mt-1 w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500" required /></div>
                <div><label htmlFor="jobTitle" className="block text-sm font-medium text-gray-700">Job Title</label><input type="text" name="jobTitle" id="jobTitle" value={formData.jobTitle} placeholder="e.g., Recruiter, HR Manager" onChange={handleChange} className="mt-1 w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500" /></div>
