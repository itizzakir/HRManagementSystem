    ...
    const DashboardLayout = ({ children, role, title, userName, userEmail }) => {
        ...
        const roleLinks = {
            admin: [
                ...
                { icon: <UsersIcon className="h-5 w-5" />, text: 'User Management', to: '#' },
                { icon: <CogIcon className="h-5 w-5" />, text: 'System Settings', to: '#' },
                { icon: <ShieldCheckIcon className="h-5 w-5" />, text: 'Compliance', to: '#' },
                { icon: <ChartBarIcon className="h-5 w-5" />, text: 'Reports', to: '#' },
            ],
            hr: [
